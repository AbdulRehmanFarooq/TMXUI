...
angular
    ...
    .controller('LeftCtrl', function ($scope, $timeout, $mdSidenav, $log, $window) {
      ...
      $scope.LeftPanel=$window.innerHeight-64-88-144;
       $scope.menuwithsub = [
         { name: 'Master Data', index:0, class:"",wanted: true, icon:'fa fa-outdent' ,subs:[{title:'Customer',link:'CustomerManagement1'},{title:'Company',link:'CompanyManagement'},{title:'Product',link:'ProductManagement'},{title:'Location',link:'LocationManagement'},{title:'Scheme',link:'SchemeManagement'},{title:'Supplier',link:'SupplierManagement'},{title:'Route',link:'RouteManagement'},{title:'Distributor',link:'DistributorManagement'},{title:'Sales',link:'SalesTargetManagement'},{title:'Pricelist',link:'PricelistManagement'}]  },
